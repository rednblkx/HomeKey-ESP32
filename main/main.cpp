...
void setup() {
  ...
  // carry it -- only messages emitted after the WebSocketLogSinker below reach
  // connected WebSocket clients, and clients only connect once WiFi and the
  // HTTP server are up seconds later. On a board with no reachable serial port

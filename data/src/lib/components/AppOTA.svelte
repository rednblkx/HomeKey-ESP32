		...
		<div class="card-body p-4">
			...
			<div class="card-actions justify-end gap-2">
				...
				>
					...
					{/if}
					<svg class:loading={uploading && currentUploadType === 'firmware'} xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
				...
				>
					{#if uploading && currentUploadType === 'littlefs'}
						<span class="loading loading-spinner loading-sm"></span>
					{/if}
					<svg class:loading={uploading && currentUploadType === 'littlefs'} xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">

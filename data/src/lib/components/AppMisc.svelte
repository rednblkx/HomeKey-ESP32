<script lang="ts">
	import { rebootDevice, resetPairings, resetWifi, saveConfig, startConfigAP } from '$lib/services/api.js';
...
<div class="flex flex-col py-6">
    ...
    <div class="flex gap-2 justify-center mb-4">
      <div class="flex flex-wrap justify-center gap-2 max-w-sm">
        <button class="btn btn-soft btn-warning" aria-label="Reboot Device" onclick={async () => {
        ...
        <button class="btn btn-soft btn-error" onclick={async () => {
